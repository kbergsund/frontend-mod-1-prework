...
if (dogAge <= 2) {
  console.log("That is a puppy!");
} else if (dogAge < 10) {
  console.log("That is an adult doggo.");
} else {
  console.log("That is a sweet, elderly doge.");
}
...
My gumball exercise did not require a logical operator but I did immediately identify that the pizza one did! I definitely understand && better now.
*/
